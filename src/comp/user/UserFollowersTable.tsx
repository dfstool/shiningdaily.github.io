...
const UserFollowersTable: React.FC<IProps> = (props) => {
  ...
  const handleFollowersData = useCallback(() => {
    if (!props.followers.length || !vip) {//判断对象是否为空
      setDataSource([]);
      return;
    }
...
export default memo(UserFollowersTable);
